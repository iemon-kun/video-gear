document.addEventListener('DOMContentLoaded', () => {
    const { normalizeSettings } = window.VideoGearSpeed;
    ...
    // 保存された設定の読み込み
    chrome.storage.sync.get(['speedStep', 'speedMin', 'speedMax', 'presets', 'toggleKeyCode', 'toggleSpeed', 'lang'], (data) => {
